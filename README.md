...
Refactored in 2026 with [Svelte](https://svelte.dev) and [SvelteKit](https://svelte.dev/), using a supervised [Claude Code](https://claude.com/product/claude-code) agentic workflow.
